...
function submitForm() {
    ...
    function getBirthdayDetails(birthdayNumber) {
        ...
        switch (birthdayNumber) {
            case 1:
                return "<p>Arriving on this day, impatience fuels your drive to be first. A natural leader, you blaze trails with ingenious ideas. While you may delegate, true happiness lies in steering the ship. You have a knack for infusing old things with a unique twist, seeking recognition for your innovative thinking. Though perceived as aloof, be mindful of your tone when met with advice.<br>In personal pursuits, you thrive outdoors, relishing sunlight and fresh air.In matters of the heart, charm and affability are your forte, accustomed to success.Honest and strong - willed, your decisive nature allowsfor quick thinking and adaptability. <br> Notable individuals born on the 1 st include Princess Diana, Justin Bieber, Dr.Phil, Harry Styles, Heidi Klum, and Zendaya. </p>";
            case 2:
                return "<p>As an individual born on the 2nd, you excel at juggling multiple responsibilities effortlessly. Fueled by ambition, you remain grounded and humble amid your numerous accomplishments. Your innate knack for diplomacy and collaborative efforts positions you as a valuable team player, and your true joy is found in cooperative endeavors.</p> <br> Despite a hectic schedule, you actively pursue balance and harmony in your life. Relationships hold a special place in your heart, and you carefully choose companions, valuing the importance of family and loved ones.Creating and maintaining a beautiful home is a source of joy for you. <br> In matters of emotion, you tend to take things to heart.Instead of underestimating yourself, recognize that your authentic self inspires others. <br> Famous figures born on the 2nd, such as Dwayne “The Rock” Johnson, singer Jon Bon Jovi, ice skater Johnny Weir, singer Shakira, talk show host Kelly Ripa, actor Salma Hayek, and singer Britney Spears, share your birthdate, adding to the collective strength of individuals born on this day. </p>";
            case 3:
                return "<p>As someone born on the 3rd, you seek a stage to showcase your creative abilities. You’re a consummate entertainer who possesses the gift of gab and a genuine ability to capture an audience. Because of your magnetic personality, you’re very popular and sought after by others, especially in a romantic way. <br> You keep an intense social calendar. Although you enjoy being the center of attention, others may find you elusive or hard to get close to. At times you don’t fully understand yourself; take the time to slow down, rest, and reflect. <br> You lead a charmed life and seem to receive good fortune easily. Rarely upset or melancholy, you quickly snap out of it when you feel stressed or blue. You’re also able to deal with problems handily because you’ve discovered the easiest route is to admit when you’re mistaken. <br> Famous people born on the 3rd: television personality Martha Stewart, journalist Anderson Cooper, comedian Eddie Murphy, singer Gwen Stefani, civil rights attorney Amal Clooney, and actor Tom Cruise.</p>";
            case 4:
