...
A static, responsive numerology profile builder and reference library.

## Features

- Full name and birth-date chart calculator
- Pythagorean and Chaldean-inspired name value modes
